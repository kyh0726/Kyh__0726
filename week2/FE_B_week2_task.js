"use strict";
const inputBox = document.getElementById("input-box"), listContainer = document.getElementById("list-container"), deleteBtn = document.getElementsByClassName('deleteTask'), savedTodoList = JSON.parse(localStorage.getItem('saved-items') || '""');
...
function addTask() {
    let inputBoxValue = document.getElementById("input-box");
...
const modifyTask = (event) => {
    ...
    const text = span === null || span === void 0 ? void 0 : span.innerText; // span의 내부 값 text에 넣어두기
    if (span) {
    ...
    li === null || li === void 0 ? void 0 : li.prepend(input); // input을 li 배열의 앞쪽에 끼워넣기
    ...
    btn.addEventListener("click", (e) => {
        ...
        if (span) {
            ...
            li === null || li === void 0 ? void 0 : li.prepend(span); // span을 앞으로 끼워넣고
        }
        li === null || li === void 0 ? void 0 : li.removeChild(input); // 수정을 마쳤으니 input은 지운다
